...
class BP_XProfile_Field_Type_Taxonomy extends BP_XProfile_Field_Type {
	...
	public function __construct() {
		...
		if ( ! has_action( 'xprofile_data_before_delete', array(
			'BP_XProfile_Field_Type_Taxonomy',
			'before_delete'
		) ) ) {
        ...
        <div id="<?php echo esc_attr( $type ); ?>" class="postbox bp-options-box"
            ...
            <div class="inside" aria-live="polite" aria-atomic="true" aria-relevant="all">
                ...
                <p>
                    ...
                    <input type="text" value="<?php echo $settings['empty_label'] ?>" name="field-settings[empty_label]"
                           id="empty_label_<?php echo esc_attr( $type ); ?>">
                </p>
                <p>
                    <label for="sync_terms_<?php echo esc_attr( $type ); ?>"><?php esc_html_e( 'Synchronise profile field to user terms:', 'buddypress' ); ?></label>
                    <input type="checkbox" value="1" <?php checked( $settings['sync_terms'] ); ?>
                           name="field-settings[sync_terms]" id="sync_terms_<?php echo esc_attr( $type ); ?>">
                </p>
                <p>
                    ...
                    <input type="checkbox" value="1" <?php checked( $settings['sync_terms_to_profile'] ); ?>
                           name="field-settings[sync_terms_to_profile]"
                           id="sync_terms_to_profile_<?php echo esc_attr( $type ); ?>">
                </p>
                <p>
                    <label for="multiple_<?php echo esc_attr( $type ); ?>"><?php esc_html_e( 'Allow multiple values:', 'buddypress' ); ?></label>
                    <input type="checkbox" value="1" <?php checked( $settings['multiple'] ); ?>
                           name="field-settings[multiple]" id="multiple_<?php echo esc_attr( $type ); ?>">
                </p>
                <p>
